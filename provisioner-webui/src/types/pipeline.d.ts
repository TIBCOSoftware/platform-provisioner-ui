...
export interface PIPELINE_OPTION {
  ...
  disableOtherFieldsWhenSet?: string[];
  ...
  enableOtherFieldsWhenSet?: string[];

  // when true, this option is only visible if ENABLE_UNRELEASED_FEATURE=true is set on the server
